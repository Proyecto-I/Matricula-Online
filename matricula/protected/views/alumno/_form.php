...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="form-group">
		<?php echo $form->labelEx($model,'CODALUMNO', array('class'=>'col-sm-2 control-label')); ?>
		<div class="col-sm-3">
			<?php echo $form->textField($model,'CODALUMNO',array('class'=>'form-control','size'=>8,'maxlength'=>8,'disabled'=>'true')); ?>
			<?php echo $form->error($model,'CODALUMNO'); ?>
		</div>
	</div>
	...
	<div class="form-group">
		...
		<div class="col-sm-3">
			<?php echo $form->passwordField($model,'CLAVE',array('class'=>'form-control','size'=>20,'maxlength'=>20)); ?>
